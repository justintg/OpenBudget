/*
 * This file was originally written as part of the gong-wpf-dragdrop project, and has
 * been slightly modified for use in OpenBudget.
 * 
 * Original source: https://github.com/punker76/gong-wpf-dragdrop/blob/dev/src/GongSolutions.WPF.DragDrop/DropTargetInsertionAdorner.cs
 */
using System;
...
{
    public class DropTargetEmptyInsertionAdorner : DropTargetAdorner
    {
        public DropTargetEmptyInsertionAdorner(UIElement adornedElement, DropInfo dropInfo)
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            if (itemsControl != null)
            {
                ...
                var showAlwaysDropTargetAdorner = itemContainer == null && GongSolutions.Wpf.DragDrop.DragDrop.GetShowAlwaysDropTargetAdorner(itemParent);
                ...
                if (itemContainer != null)
                {
                    ...
                    if (dropInfo.VisualTargetOrientation == Orientation.Vertical)
                    {
                        ...
                        point1 = new Point(itemRectLeft, 0);
                        point2 = new Point(itemRectRight, 0);
                    }
                    else
                    {
        ...
        static DropTargetEmptyInsertionAdorner()
        {

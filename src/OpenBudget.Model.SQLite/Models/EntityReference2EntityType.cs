...
{
    internal partial class EntityReference2EntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "OpenBudget.Model.Entities.CategorySnapshot.Parent#EntityReference",
                typeof(EntityReference),
                baseEntityType,
                sharedClrType: true);

            var categorySnapshotEntityID = runtimeEntityType.AddProperty(
                "CategorySnapshotEntityID",
                typeof(string),
        ...
        {
            var runtimeForeignKey = declaringEntityType.AddForeignKey(new[] { declaringEntityType.FindProperty("CategorySnapshotEntityID") },

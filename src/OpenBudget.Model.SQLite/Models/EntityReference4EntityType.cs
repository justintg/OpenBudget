...
{
    internal partial class EntityReference4EntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "OpenBudget.Model.Entities.MasterCategorySnapshot.Parent#EntityReference",
                typeof(EntityReference),
                baseEntityType,
                sharedClrType: true);

            var masterCategorySnapshotEntityID = runtimeEntityType.AddProperty(
                "MasterCategorySnapshotEntityID",
                typeof(string),
            ...
            var key = runtimeEntityType.AddKey(
                new[] { masterCategorySnapshotEntityID });
        ...
        {
            var runtimeForeignKey = declaringEntityType.AddForeignKey(new[] { declaringEntityType.FindProperty("MasterCategorySnapshotEntityID") },

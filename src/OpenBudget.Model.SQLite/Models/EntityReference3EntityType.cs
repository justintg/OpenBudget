...
{
    internal partial class EntityReference3EntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "OpenBudget.Model.Entities.IncomeCategorySnapshot.Parent#EntityReference",
                typeof(EntityReference),
                baseEntityType,
                sharedClrType: true);

            var incomeCategorySnapshotEntityID = runtimeEntityType.AddProperty(
                "IncomeCategorySnapshotEntityID",
                typeof(string),
            ...
            var key = runtimeEntityType.AddKey(
                new[] { incomeCategorySnapshotEntityID });
        ...
        {
            var runtimeForeignKey = declaringEntityType.AddForeignKey(new[] { declaringEntityType.FindProperty("IncomeCategorySnapshotEntityID") },

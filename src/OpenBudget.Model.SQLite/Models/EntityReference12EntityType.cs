...
{
    internal partial class EntityReference12EntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "OpenBudget.Model.Entities.TransactionSnapshot.PayeeOrAccount#EntityReference",
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var payeeOrAccount = principalEntityType.AddNavigation("PayeeOrAccount",
                runtimeForeignKey,
                onDependent: false,
                typeof(EntityReference),
                propertyInfo: typeof(TransactionSnapshot).GetProperty("PayeeOrAccount", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(TransactionSnapshot).GetField("<PayeeOrAccount>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                eagerLoaded: true);

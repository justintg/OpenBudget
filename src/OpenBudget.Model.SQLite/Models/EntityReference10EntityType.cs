...
{
    internal partial class EntityReference10EntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "OpenBudget.Model.Entities.TransactionSnapshot.OtherTransaction#EntityReference",
        ...
        public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var otherTransaction = principalEntityType.AddNavigation("OtherTransaction",
                runtimeForeignKey,
                onDependent: false,
                typeof(EntityReference),
                propertyInfo: typeof(TransactionSnapshot).GetProperty("OtherTransaction", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(TransactionSnapshot).GetField("<OtherTransaction>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                eagerLoaded: true);

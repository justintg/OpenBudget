...
{
    internal partial class BudgetSnapshotEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "OpenBudget.Model.Entities.BudgetSnapshot",
                typeof(BudgetSnapshot),
                baseEntityType);
            ...
            var currency = runtimeEntityType.AddProperty(
                "Currency",
                typeof(string),
                propertyInfo: typeof(BudgetSnapshot).GetProperty("Currency", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(BudgetSnapshot).GetField("<Currency>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);

            var currencyCulture = runtimeEntityType.AddProperty(
                "CurrencyCulture",
                typeof(string),
                propertyInfo: typeof(BudgetSnapshot).GetProperty("CurrencyCulture", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(BudgetSnapshot).GetField("<CurrencyCulture>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);

            var currencyDecimals = runtimeEntityType.AddProperty(
                "CurrencyDecimals",
                typeof(int?),
                propertyInfo: typeof(BudgetSnapshot).GetProperty("CurrencyDecimals", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(BudgetSnapshot).GetField("<CurrencyDecimals>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);
            ...
            var name = runtimeEntityType.AddProperty(
                "Name",
                typeof(string),
                propertyInfo: typeof(BudgetSnapshot).GetProperty("Name", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(BudgetSnapshot).GetField("<Name>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                nullable: true);

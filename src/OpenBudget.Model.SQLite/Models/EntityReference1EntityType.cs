...
{
    internal partial class EntityReference1EntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "OpenBudget.Model.Entities.CategoryMonthSnapshot.Parent#EntityReference",
                typeof(EntityReference),
                baseEntityType,
                sharedClrType: true);

            var categoryMonthSnapshotEntityID = runtimeEntityType.AddProperty(
                "CategoryMonthSnapshotEntityID",
                typeof(string),
            ...
            var key = runtimeEntityType.AddKey(
                new[] { categoryMonthSnapshotEntityID });
        ...
        {
            var runtimeForeignKey = declaringEntityType.AddForeignKey(new[] { declaringEntityType.FindProperty("CategoryMonthSnapshotEntityID") },
